  ...
  <div class="govuk-grid-row">
    <div class="govuk-grid-column-two-thirds">
      ...
      <TaskList>
        ...
        >
          <Task
            v-if="candidateForm.parts.candidateAvailability"
            id="apply-personal-details"
            title="Personal details"
            :done="candidateFormResponse.progess.candidateAvailability"
            :locked="!currentApplicationParts.personalDetails"
          />
          <Task
            v-if="candidateForm.parts.panellistConflicts"
            id="tes"
            title="Character information"
            :done="candidateFormResponse.progess.panellistConflicts"
            :locked="!currentApplicationParts.characterInformation"
          />
          <Task
            v-if="candidateForm.parts.commissionerConflicts"
            id="equality-and-diversity-survey"
            title="Equality and diversity"
            :done="candidateFormResponse.progess.commissionerConflicts"
            :locked="!currentApplicationParts.equalityAndDiversitySurvey"
          />
          <Task
            v-if="candidateForm.parts.characterChecks"
            id="equality-and-diversity-survey"
            title="Equality and diversity"
            :done="candidateFormResponse.progess.characterChecks"
            :locked="!currentApplicationParts.equalityAndDiversitySurvey"
          />
          <Task
            v-if="candidateForm.parts.reasonableAdjustments"
            id="equality-and-diversity-survey"
            title="Equality and diversity"
            :done="candidateFormResponse.progess.reasonableAdjustments"
            :locked="!currentApplicationParts.equalityAndDiversitySurvey"
          />
          <Task
            v-if="candidateForm.parts.workingPreferences"
            id="equality-and-diversity-survey"
            title="Equality and diversity"
            :done="candidateFormResponse.progess.workingPreferences"
            :locked="!currentApplicationParts.equalityAndDiversitySurvey"
          />
          <Task
            v-if="candidateForm.parts.welshPosts"
            id="equality-and-diversity-survey"
            title="Equality and diversity"
            :done="candidateFormResponse.progess.welshPosts"
            :locked="!currentApplicationParts.equalityAndDiversitySurvey"
          />
        </TaskGroup> -->
