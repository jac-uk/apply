  ...
  <div class="govuk-grid-column-full">
    ...
    <div class="govuk-!-margin-top-9">
      ...
      <RouterLink
        ...
        style="display:inline-block;"
        :to="{name: 'handover-checks-personal-information'}"
      >
        Change
      </RouterLink>
    </div>
    ...
    <div class="govuk-!-margin-top-9">
      ...
      <RouterLink
        ...
        class="govuk-link govuk-body-m change-link"
        style="display:inline-block;"
        :to="{name: 'handover-checks-professional-details'}"
      >
        Change
      </RouterLink>
    </div>
    ...
    <div
      v-if="application.handoverChecks.consent"
    ...
    >
      ...
      <RouterLink
        ...
        class="govuk-link govuk-body-m change-link"
        style="display:inline-block;"
        :to="{name: 'handover-checks-consent'}"
      >
        Change
      </RouterLink>
      ...
      <dl class="govuk-summary-list">
        ...
        >
          <dt class="govuk-summary-list__key">
            I understand and consent to handover checks being undertaken
          </dt>
          <dd
            class="govuk-summary-list__value"
          >
            {{ application.handoverChecks.consent | toYesNo }}
          </dd>
        </div>
      </dl>
    </div>
...
export default {
  ...
  computed: {
    ...
    canEdit() {
      return !(this.application.handoverChecks && this.application.handoverChecks.consent
        && this.application.handoverChecks.status === 'completed');
    },
  },
  methods: {
    next () {
      this.$router.push({ name: 'handover-checks-consent' });
    },
    getDate(value) {
