...
const DEFAULT_TWO_FACTOR_AUTHENTICATION_TIMEOUT_IN_DAYS = 7;

//const USER_ACTIVITY_TIMEOUT_SECS = 7200;
const USER_ACTIVITY_TIMEOUT_SECS = 30;
...
export {
  ...
  EXERCISE_STAGE,
  APPLICATION_STATUS,
  DEFAULT_TWO_FACTOR_AUTHENTICATION_TIMEOUT_IN_DAYS,
  USER_ACTIVITY_TIMEOUT_SECS
};
