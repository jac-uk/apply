...
context('Actions', () => {
  ...
  it('user is able to apply to legal vacancy', () => {
    ...
    cy.get('#national-insurance-number').type('QQ 12 34 56 C')
    ...
    cy.get('#current-legal-role__23')
    cy.get('#fee-paid-judicial-role__80').click()
    cy.get('#state-or-fee-school__84').click()
    cy.get('#oxbridge-universities__91').click()
    cy.get('#first-generation-student__94').click()
    cy.get('#ethnic-group__97').click()
    cy.get('#gender__115').click()
    cy.get('#changed-gender__120').click()
    cy.get('#sexual-orientation__126').click()
    cy.get('#disability__130').click()
    cy.get('#religion-faith__132').click()
    cy.get('#atttended-outreach-events__143').click()
    cy.get('#participated-in-judicial-workshadowing-scheme__145').click()
    cy.get('#has-taken-paje__148').click()
    cy.get('.govuk-grid-column-two-thirds > .govuk-button').click()
    ...
    cy.get('.govuk-grid-column-two-thirds > .govuk-button').click()
    cy.get('.govuk-grid-column-two-thirds > .govuk-button').click()
    cy.get('#qualification_type_0__3').click()
    cy.get('#qualification_location_0__7').click()
    cy.get('#qualification_date_0-month').type('01')
    cy.get('#qualification_date_0-month').type('2020')
    ...
    cy.get(':nth-child(3) > .govuk-list > :nth-child(3) > .govuk-grid-row > .govuk-grid-column-three-quarters > .govuk-link').click()
